...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public TransactionServiceDto createTransaction(TransactionServiceDto transaction) {
    ...
    @Override
    public Optional<TransactionServiceDto> getTransactionById(Long id) {
        log.info("Fetching transaction with id: {}", id);
        return transactionAdapter.findById(id).map(this::toServiceDto);
    }

    @Override
    public List<TransactionServiceDto> getAllTransactions() {
    ...
    @Override
    public List<TransactionServiceDto> getTransactionsByUserid(Long userid) {
    ...
    @Override
    public TransactionServiceDto updateTransaction(Long id, TransactionServiceDto transaction) {
    ...
    private TransactionRepositoryDto toRepoDto(TransactionServiceDto dto) {
        return new TransactionRepositoryDto(dto.id(), dto.userid(), dto.value(), dto.details(), dto.date());
    }

    private TransactionServiceDto toServiceDto(TransactionRepositoryDto dto) {
